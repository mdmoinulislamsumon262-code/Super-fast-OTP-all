...
def _temp_mail_extract_otp(subject: str, message_text: str) -> str:
    ...
    patterns = (
        ...
        r"(?i)\b(?:code|otp)\s*[:#\-=]?\s*([A-Z0-9]{4,8})\b",
        r"(?<![0-9])([0-9]{6})(?![0-9])",
        r"(?<![0-9])([0-9]{4,8})(?![0-9])",
    )
    ...
    async with user_lock:
        ...
        for message in messages:
            ...
            notification = (
                ...
                "━━━━━━━━━━━━━━━━━━\n"
                f"📪 <b>Mailbox:</b> <code>{_html.escape(mailbox_email)}</code>\n"
                f"🧑‍💼 <b>From:</b> <code>{_html.escape(sender)}</code>\n"
                f"🏷️ <b>Subject:</b> {_html.escape(subject)}\n"
                "━━━━━━━━━━━━━━━━━━\n"
                f"🔐 <b>OTP CODE:</b> <code>{_html.escape(otp)}</code>\n"
                "━━━━━━━━━━━━━━━━━━\n"
...
def start_health_server():
    ...
    for candidate in (port, port + 1, 0):
        try:
